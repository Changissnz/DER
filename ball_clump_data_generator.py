...
import pickle
"""
Derives data from class<NSDataInstructions>
"""
class BallClumpDataGenerator:

    """

    clusterInfo := 2-tuple, [0] is sequence of i'th ball's cluster radii ratios
                            [1] is sequence of i'th ball's density measures d,
                                each cluster will have d points
    """
    ...
    def set_frame(self):
        ...
        for (i,b) in enumerate(self.balls):
            ...
            print("cluster densitys ", len(self.clusterInfo[1][i]))
            """
            ##
