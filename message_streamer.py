...
"""
class is to "stream" data from a file source,
(image = jpg file)|(text = 'literal'|'csv')
"""
class MessageStreamer:
    ...
    """
    set `readMode` to "r" for reading csv files
    """
    ...
    """
    return:
    - list::(block of data), bool::(terminate stream), bool::(finished stream)
    """
